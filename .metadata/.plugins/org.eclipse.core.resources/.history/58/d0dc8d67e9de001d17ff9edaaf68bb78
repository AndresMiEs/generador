...
public class GeneradorController {
    ...
    public ResponseEntity<byte[]> getGenerador() throws IOException {
        ...
        Resource resource = resourceLoader.getResource("classpath:static/html/Generador.html");

        logger.info("Cargando archivo Generador.html");
        ...
        logger.info("Archivo Generador.html cargado correctamente");
